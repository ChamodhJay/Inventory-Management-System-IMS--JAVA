 ...
 * @author wizky
 */
public class MainItems_RB extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item ID", "Category ID", "Item Name", "Description"
            }
        ));
        ...
        jLabel2.setText("Removed Main Items");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainItems_RB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainItems_RB().setVisible(true);
            }
        });
    }
