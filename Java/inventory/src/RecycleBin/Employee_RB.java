 ...
 * @author wizky
 */
public class Employee_RB extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Removed Employees");
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Employee ID", "Name", "Address", "Phone Number", "NIC", "Description"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Employee_RB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Employee_RB().setVisible(true);
            }
        });
    }
