 ...
 * @author W I Z K Y
 */
public class ElectricItems_RB extends javax.swing.JFrame {

    /**
     * Creates new form Computer_Page
     */
    public ElectricItems_RB() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Add.setText("Removed Electric Items");
        getContentPane().add(Add, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 80, -1, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Removed Electric Items.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ElectricItems_RB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ElectricItems_RB().setVisible(true);
            }
        });
    }
