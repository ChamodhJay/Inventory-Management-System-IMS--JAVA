 ...
 * @author wizky
 */
public class Returning_RB extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Removed Returning Types");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Returning_RB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Returning_RB().setVisible(true);
            }
        });
    }
