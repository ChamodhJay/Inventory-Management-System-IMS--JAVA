 ...
 * @author W I Z K Y
 */
public class FurnitureItems_RB extends javax.swing.JFrame {

    /**
     * Creates new form Computer_Page
     */
    public FurnitureItems_RB() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Add.setText("Removed Furniture Items");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FurnitureItems_RB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FurnitureItems_RB().setVisible(true);
            }
        });
    }
