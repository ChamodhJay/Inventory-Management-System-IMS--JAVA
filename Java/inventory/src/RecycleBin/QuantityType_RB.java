 ...
 * @author wizky
 */
public class QuantityType_RB extends javax.swing.JFrame {

    /**
     * Creates new form Category_R_Bin
     */
    public QuantityType_RB() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Quantity Type ID", "Name", "Description"
            }
        ));
        ...
        jLabel2.setText("Removed Quantity Types");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 60, 230, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuantityType_RB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuantityType_RB().setVisible(true);
            }
        });
    }
